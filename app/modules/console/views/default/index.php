    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-green">
                ...
                <div class="stats-desc">上周同比 (70.1%)</div>
            </div>
        </div>
        <!-- end col-3 -->
        <!-- begin col-3 -->
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-blue">
                ...
                <div class="stats-title">今日利润</div>
                <div class="stats-number">180,200</div>
                <div class="stats-progress progress">
                    <div class="progress-bar" style="width: 40.5%;"></div>
                </div>
                <div class="stats-desc">上周同比 (40.5%)</div>
            </div>
        </div>
        <!-- end col-3 -->
        <!-- begin col-3 -->
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-purple">
                ...
                <div class="stats-desc">上周同比 (76.3%)</div>
            </div>
        </div>
        <!-- end col-3 -->
        <!-- begin col-3 -->
        <div class="col-md-3 col-sm-6">
            <div class="widget widget-stats bg-black">
                ...
                <div class="stats-desc">上周同比 (54.9%)</div>
            </div>
        </div>
        <!-- end col-3 -->
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-2">
                <div class="panel-heading">
                    <h4 class="panel-title">管理沟通 <span
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-3">
                <div class="panel-heading">
                    <h4 class="panel-title">今日工作计划</h4>
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-inverse" data-sortable-id="index-4">
                <div class="panel-heading">
                    <h4 class="panel-title">新注册用户 <span class="pull-right label label-success">24 new users</span>
                    </h4>
                </div>
